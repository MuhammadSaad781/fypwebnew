...
export default function LandingPage() {
  ...
  return (
    <div>
      ...
      <div class="container">
        <div class="row" style={{ marginTop: "7rem" }}>
          <div class="col">
      ...
      <div class="container mt-4" style={{ color: "#242F9B", fontSize: 20 }}>
        <p>How it Works</p>
      </div>
      <div
        style={{
      ...
      >
        <div class="container">
          <p class="pt-4" style={{ color: "white", fontSize: 20 }}>
            CrowdFunding
          </p>
      ...
      <div>
        <p class="text-center" style={{ color: "#242F9B", fontSize: 40 }}>
          Request More Information
        </p>
        <p class="text-center" style={{ color: "#242F9B", fontSize: 15 }}>
